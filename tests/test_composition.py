...
def test_brotr_composition():
    ...
    brotr1 = Brotr(pool=pool, default_batch_size=200)
    print(f"   {brotr1}")
    ...
    print(f"   Batch size: {brotr1.config.batch.default_batch_size}")
    ...
    print(f"   Batch size: {brotr2.config.batch.default_batch_size}")
    ...
    print(f"   Brotr has insert_event method? {hasattr(brotr1, 'insert_event')}")
    ...
    print(f"   Batch size (default): {brotr3.config.batch.default_batch_size}")
    ...
    print("   - API Option 1: Brotr(pool=custom_pool, default_batch_size=...)")
    print("   - API Option 2: Brotr(default_batch_size=...) → uses default pool")
    ...
    print("   - Stored procedures: brotr.insert_event(), brotr.cleanup_orphans(), etc.")
