...
def generate_seed(relays_url_csv_path):
    ...
    relays_seed.to_csv('relays_seed.csv', index=False)
    relays_seed['relay_url'].to_csv(
        'relays_seed.txt', index=False, header=False)


if __name__ == '__main__':
    relays_url_csv_path = 'relays_url.csv'
    generate_seed(relays_url_csv_path)
